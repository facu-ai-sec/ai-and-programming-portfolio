...
This repository contains a collection of independent Python projects developed for learning, experimentation, and portfolio purposes. The projects cover a broad range of topics, including automation, data analysis, machine learning, computer vision, and introductory cybersecurity tools.

All scripts were created as part of a self-directed study process while preparing for university programs related to Computer Science, Artificial Intelligence, and Information Security. Each project focuses on applying theoretical concepts to practical, real-world problems.
...
Each project is documented individually within its respective folder.
...
- Problem-solving skills and logical code structuring  
- Progressive learning through increasingly complex projects  
- Strong interest in Artificial Intelligence and Cybersecurity as academic and professional paths  
...
If you would like to know more about any project, feel free to reach out. LinkedIn: www.linkedin.com/in/facundo-pardo-662b9039a
